...
class Order(models.Model):
    ...
    user = models.ForeignKey(to=settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.SET_DEFAULT,
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(to=Product, on_delete=models.SET_DEFAULT, blank=True, null=True, verbose_name='Товар',
                                default=None)
