...
from .views import CreateOrderReviewView, EditOrderReviewView, CreateProductReviewView
...
urlpatterns = [
    ...
    path('edit-product-review/<slug:product_slug>', EditOrderReviewView.as_view(), name='edit_product_review'),
]
